...
class Staff(models.Model):
    ...
    branch_no = models.ForeignKey(Branch, models.DO_NOTHING, db_column='branch_no')
...
class ViewReport(models.Model):
    propertyno = models.ForeignKey(Propertyforrent, models.DO_NOTHING, db_column='propertyNo')  # Field name made lowercase.
